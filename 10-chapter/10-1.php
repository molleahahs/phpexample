...
<title>获取指定任意一天的时间</title><form id="form1" name="form1" method="post" action="10-1.php">
<table width="446" border="5" cellpadding="5" cellspacing="5" bordercolor="#97C5F7">
  ...
  <tr>
    <td height="26" colspan="3" align="center"><span class="STYLE5">正确的日期为:<?php if(isset($_POST['Submit'])) echo $truedate;?></span></td>
  </tr>
  <tr>
